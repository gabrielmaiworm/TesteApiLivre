...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFOADICIONAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_INFOADICIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INFOADICIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INFOADICIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INFOADICIONAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INFOADICIONAL actions', async () => {
      const expectedActions = [
        {
