...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPAMENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_EQUIPAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EQUIPAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EQUIPAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EQUIPAMENTO actions', async () => {
      const expectedActions = [
        {
