...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bateria.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BATERIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_BATERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BATERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BATERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BATERIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BATERIA actions', async () => {
      const expectedActions = [
        {
