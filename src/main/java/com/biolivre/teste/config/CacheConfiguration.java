package com.biolivre.teste.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.biolivre.teste.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.biolivre.teste.repository.UserRepository.USERS_BY_EMAIL_CACHE);
